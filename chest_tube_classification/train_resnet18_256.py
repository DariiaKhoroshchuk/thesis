...
from models import get_custom_resnet18
...
if __name__ == '__main__':
    t0 = time.time()
    # load training data
    train_dataset = CustomDataset('train_org_filtered', augmentations=train_transform, kind=None)
    ...
    val_dataset = CustomDataset('validation_org_filtered', augmentations=validation_transform, kind=None)
    ...
    save_dir = f'{CHECKPOINT_DIR}/resnet18_256_hist_eq{lr}_{batch_size}'
