...
from dataset import CustomDataset, test_transform
import torch
import numpy as np
...
def test(model, dataloader, criterion, device, model_name):
    ...
    plot_confusion_matrix(cm, [0, 1], model_name)
...
if __name__ == '__main__':
    model_name = 'cnn_0.0001_8'
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    batch_size = 8

    test_dataset = CustomDataset('test', augmentations=test_transform, kind=None)
